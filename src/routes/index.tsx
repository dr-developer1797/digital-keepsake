...
const adventures = [
  {
    icon: Plane,
    title: "✈️ Tokyo in spring",
    text: "Cherry blossoms, tiny coffee shops, getting lost on purpose.",
  },
  {
    icon: Mountain,
    title: "🌅 A real road trip",
    text: "Watch a sunrise... after staying up & roaming all night while talking.",
  },
  {
    icon: Utensils,
    title: "☕ Find a coffee place",
    text: "Where even you'd admit...the coffee was worth it.",
  },
  {
    icon: BookOpen,
